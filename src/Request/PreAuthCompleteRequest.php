...
final readonly class PreAuthCompleteRequest implements RequestInterface
{
    ...
    {
        return TransactionType::PreAuthComplete;
    }
    ...
    public function getSigningFields(): array
    {
        return [
            ...
            'TRTYPE' => (string) TransactionType::PreAuthComplete->value,
            'AMOUNT' => $this->amount,
